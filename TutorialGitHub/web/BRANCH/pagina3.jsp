<%-- 
    Document   : pagina2
    Created on : 05/05/2017, 21:53:31
    Author     : MauMau
--%>
            ...
            <div class="container text-left">    
                <div class="row content">
                    ...
                    <div class="col-sm-10 text-left conteudoCentro"> 
                        ...
                        <div class="col-md-8">
                            <h1>Avaliação Branch</h1>
                            <p><b>Meus parabéns aluno</b>, você chegou ao fim do módulo de "Brach" de nosso tutorial, esperamos que 
                                tenha conseguido reter o máximo de informação e aprendido com o que foi passado sobre o assunto, pois agora iniciaremos
                                uma pequena avaliação para testar seus conhecimentos sobre o modulo apresentado(brach).<br> Responda as questões para 
                        ...
                        <div class="panel panel-info col-md-4 text-left">
                            ...
                            <div class="panel-heading"><b>Questão 1)</b>Modelo questão</div>
                            <!-- List group -->
                            <div class="input-group">     
                                <div class="radio" >
                                    <label><input type="radio" name="questao1" id="qst1-1" value="1">Opção 1</label>
                                </div>
                                <div class="radio" >
                                    <label><input type="radio" name="questao1" id="qst1-2" value="2">Opção 2</label>
                                </div>
                                <div class="radio" >
                                    <label><input type="radio" name="questao1" id="qst1-3" value="3">Opção 3</label>
                                </div>
                        ...
                        <div class="panel panel-info col-md-4 text-left">
                            <!-- Default panel contents -->
                            <div class="panel-heading"><b>Questão 2)</b> Modelo questão</div>
                            <!-- List group -->
                            <div class="input-group">     
                                <div class="radio" >
                                    <label><input type="radio" name="questao2" id="qst2-1" value="1">Opção 1</label>
                                </div>
                                <div class="radio" >
                                    <label><input type="radio" name="questao2" id="qst2-2" value="2">Opção 2</label>
                                </div>
                                <div class="radio" >
                                    <label><input type="radio" name="questao2" id="qst2-3" value="3">Opção 3</label>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <div class="col-md-4 pagination">
                                    <a href="../MERGE/pagina1.jsp"><button type="button" class="btn btn-info ">Proximo Modulo
