            ...
            <div class="container text-left">    
                <div class="row content">
                    ...
                    <div class="col-sm-10 text-left conteudoCentro"> 
                        ...
                        <div class="col-md-8">
                            <h1>Avaliação Restore</h1>
                            <p><b>Meus parabéns aluno</b>, você chegou ao fim do módulo de "Restore" de nosso tutorial, esperamos que 
                                tenha conseguido reter o máximo de informação e aprendido com o que foi passado sobre o assunto, pois agora iniciaremos
                                uma pequena avaliação para testar seus conhecimentos sobre o modulo apresentado(restore).</br> Responda as questões para 
