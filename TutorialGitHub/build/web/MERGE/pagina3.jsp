<%-- 
    Document   : pagina2
    Created on : 05/05/2017, 21:56:44
    Author     : MauMau
--%>
                ...
                <div class="row content">
                    ...
                    <div class="list-group list-group-root col-md-2 sidenav">
                        ...
                        <div class="list-group">
                            ...
                            <a href="${pageContext.request.contextPath}/MERGE/pagina1.jsp" class="list-group-item active">Merge</a>
                    ...
                    <div class="col-sm-10 text-left conteudoCentro"> 
                        ...
                        <div class="col-md-8">
                            <h1>Avaliação Merge</h1>
                            <p><b>Meus parabéns aluno</b>, você chegou ao fim do módulo de "Merge" de nosso tutorial, esperamos que 
                                tenha conseguido reter o máximo de informação e aprendido com o que foi passado sobre o assunto, pois agora iniciaremos
                                uma pequena avaliação para testar seus conhecimentos sobre o modulo apresentado(merge).</br> Responda as questões para 
                        ...
                        <div class="row">
                            <div class="col-md-12 text-center">
                                ...
                                <div class="col-md-4 pagination">
                                    <a href="../TAG/pagina1.jsp"><button type="button" class="btn btn-info ">Proximo Modulo
